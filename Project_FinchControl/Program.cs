...
namespace Project_FinchControl
{
    ...
    class Program
    {
        ...
        static void WriteTheme(ConsoleColor backgroundColor, ConsoleColor foregroundColor, string dataPath)
        {
            ...
            File.WriteAllLines(dataPath, backgroundColor, foregroundColor);
        }
        (ConsoleColor backgroundColor, ConsoleColor foregroundColor) ReadTheme()
        {
            ...
            foreach (string foreground in foregroundColorString)
            {
                Enum.TryParse(foreground, out foregroundColor);

                foregroundColors.Add(foregroundColor);
            }

            backgroundColorString = File.ReadAllLines(dataPath);

            foreach (string background in backgroundColorString)
            {
                Enum.TryParse(background, out backgroundColor);
